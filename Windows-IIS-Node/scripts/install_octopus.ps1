...
$roles = "au-app-server","au-web-server"
$environments = "Development", "Testing"
$installLocation = "C:\Octopus"
$machineName = "au-npd-app2"
...
function installTentacle {
    ...
    # This downloads specific version:
    $downloader.DownloadFile("https://download.octopusdeploy.com/octopus/Octopus.Tentacle.3.16.1-x64.msi", "Tentacle.msi")
